...
double f1,L,V0;
L = 2.0; V0 = 10.0;
f1 = sqrt(2.0*(V0-E)) - sqrt(2.0*E)*(sin(L/2.0*sqrt(2.0*E)))/(cos(L/2.0*sqrt(2.0*E)));
return f1;
}
...
double g1,L,V0;
L = 2.0; V0 = 10.0;
g1 = -1.0/(sqrt(2.0*(V0-E))) - ((tan(L/2.0*sqrt(2.0*E)))/(sqrt(2.0*E)) + (sqrt(2.0*E)*L)/(2.0*sqrt(2.0*E)*pow(cos(L/2.0*sqrt(2.0*E)),2.0)));
return g1;	
}	
